...
knitr::include_graphics(path = "https://bitss.github.io/ACRE/BITSS_logo_horizontal.png")
``` 
...
```{r, echo=FALSE, fig.align = 'center', out.width = '75%'}
knitr::include_graphics(path = "https://cpb-eu-w2.wpmucdn.com/blogs.bristol.ac.uk/dist/b/631/files/2020/09/UKRN-Logo-150-extra2.png")
``` 
...
```{r, echo=FALSE, fig.align = 'center', out.width = '75%'}
knitr::include_graphics(path = "https://i.ytimg.com/vi/5joKl7fcIvE/maxresdefault.jpg")
``` 
 #### Objetivos y visión {-}
